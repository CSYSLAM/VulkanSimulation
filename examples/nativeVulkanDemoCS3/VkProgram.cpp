...
namespace CsyVk
{
	...
	bool VkProgram::load(std::string fileName)
	{
		...
		{
			pushConstantRanges.push_back(csyvk::initializers::pushConstantRange(VK_SHADER_STAGE_COMPUTE_BIT, mFormalConstants[i]->bufferSize(), i));
		}
	...
	VkMultiProgram::VkMultiProgram()
	{
		...
		VkCommandBufferAllocateInfo cmdBufAllocateInfo =
			csyvk::initializers::commandBufferAllocateInfo(commandPool, VK_COMMAND_BUFFER_LEVEL_PRIMARY, 1);
